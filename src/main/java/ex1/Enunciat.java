...
/*
 * meter un elemento que no va a colisionar -> OK
 * "" un elemento que no colisione con el anterior  -> OK
 * "" un elemento que colisiona -> OK
 * que cambie el valor de una clave repetida -> ARREGLADO
 * borrar un elemento que no existe -> OK
 * borrar un elemento que no tiene colusiones -> OK
 * borrar un elemento que tiene colusiones y es el primero de la lista -> ARREGLADO
 * borrar un elemento que tiene colusiones y es el ultimo de la lista -> OK
 * borrar un elemento que tiene colusiones y es el del medio de la lista -> OK
 * metodo count -> OK
 * metodo get primera posicion -> OK
 * metodo get posicion cualquiera de enmedio -> ARREGLADA
 * metodo get ultima posicion -> OK
 * TOTAL SOLUCIONADO 5
 * */
